...
//		LoadBMP(texturename);
	if(strstr(texturename, ".tga"))	
		...
		texture[0] = LoadTexImage(texturename);
...
//
//////////////////////////////////////////////////////////////////////////
GLuint GLTexture::LoadTexImage( char* theFileName)
{
...
//		glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_WRAP_T, GL_CLAMP_TO_EDGE);
		...
		glGenerateMipmapEXT(GL_TEXTURE_2D); // Note: This requires OpenGL 3.0 or higher
	}
	...
	cout << "Texture creation successful. - " << theFileName << endl;
